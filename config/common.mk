...
PRODUCT_COPY_FILES += \
    vendor/nameless/prebuilt/bin/f2fs/format.sh:system/install/f2fs/format.sh \
    vendor/nameless/prebuilt/bin/f2fs/trigger.sh:system/install/f2fs/trigger.sh \

# Additional tools
PRODUCT_COPY_FILES += \
    vendor/nameless/prebuilt/bin/mkbootimg:system/install/f2fs/tools/mkbootimg \
    vendor/nameless/prebuilt/bin/unpackbootimg:system/install/f2fs/tools/unpackbootimg \

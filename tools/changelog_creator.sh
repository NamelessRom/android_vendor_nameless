...
update_name=${outputfile}
update_md5=$( cut -d ' ' -f 1 <<< $(md5sum ${update_name}))
...
# Body
echo -n '<body><div class="container"><h1>NamelessRom&nbsp;<small>'${changes_since}'</small></h1><h4 style="padding-top:10px;padding-bottom:20px;">'${update_name}'&nbsp;<small>'${update_md5}'</small></h4><ul class="list-group">' >> ${outputfile}
...
do
    ...
    if [ -z "${log}" ]; then
        ...
        do
            ...
            echo -n '<li class="'${project}'-content list-group-item hidden" style="background-color:#f7f7f9;margin-left:10px;"><a href="https://github.com/NamelessRom/'${project}'/commit/'${change_id}'"><b>'${change_id}'</b></a>&nbsp;-&nbsp;<em>'${change_title}'</em></li>' >> ${tmpfile}content

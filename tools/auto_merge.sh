...
repos=( "development" "frameworks_av" "frameworks_native" "frameworks_opt_telephony" "hardware_broadcom_wlan" "hardware_qcom_audio-caf" "hardware_qcom_display-caf" "hardware_qcom_media-caf" "packages_apps_Apollo" "packages_apps_Browser" "packages_apps_Camera2" "packages_apps_DeskClock" "packages_apps_Dialer" "packages_apps_Gallery2" "packages_apps_InCallUI" "packages_apps_Mms" "packages_inputmethods_LatinIME" "packages_services_Telephony" "system_core" "system_media" )

...
repos=( "development" "frameworks_av" "frameworks_native" "frameworks_opt_telephony" "hardware_broadcom_wlan" "packages_apps_Browser" "packages_apps_ContactsCommon" "packages_apps_Dialer" "packages_apps_InCallUI" "packages_apps_Mms" "packages_inputmethods_LatinIME" "packages_providers_ContactsProvider" "packages_services_Telephony" "system_core" "system_media" )
